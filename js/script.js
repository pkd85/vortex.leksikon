...
'U svoj život privlačim samo one ljude koji su uskladu sa mnom i koji me vole bezuslovno.',
'Ja i _________ smo prijatelji zauvijek. Savršeno razumijemo i upotpunjujemo jedno drugo.',
'Moj(a) _________ i ja smo srodne duše. Upotpunjujemo, poštujemo i volimo jedno drugo beskrajno.',
'U svojim odnosima jasno izražavam svoje želje i potrebe.',
'Stalno unapređujem i produbljujem svoje odnose.',
'Moj odnos sa _________ je popravlja iz dana u dan.',
'Zaslužujem da imam zdrave odnose.',
'Izuzetno mi je važno da imam zdrave odnose.',
'Srećna sam i zadovoljna sobom i svim svojim odnosima.',
'Uvijek unosim pozitivnost u svoje odnose.',
'Moj odnos sa __________ postaje zdraviji i srećniji.',
'Privlačim ljude pozitivnom energijom.',
'Uživam u upoznavanju novih ljudi.',
'U svoj život privlačim divne pozitivne ljude.',
'Prijateljstva sklapam sa lakoćom.',
'Stranci koje upoznajem brzo postaju moji prijatelji.',
'Zaslužujem poštovanje svojih prijatelja i porodice.',
'Uvijek imam prijatelje na koje mogu računati.',
'Moji prijatelji su uvijek tu za mene kada su mi potrebni.',
'Imam potpuno povjerenje u svoje prijatelje.',
'Činim usluge ljudima, a zauzvrat ih oni čine meni.',
'Njegujem svoje odnose sa ljubavlju.',
'Lako izlazim na kraj sa svim izazovima koje srećem u svojim odnosima.',
'Za svoje prijatelje biram dobrodušne ljude.',
'Biram da popravim odnos sa samom sobom.',
'Imam zdrave odnose u svim područjima mog života.',
'Vrijeme koje provodim s prijateljima je dragocjeno.',
'Okružena sam ljudima koji me vole i podržavaju.',
